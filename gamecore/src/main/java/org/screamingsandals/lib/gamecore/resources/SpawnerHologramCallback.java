...
import org.screamingsandals.lib.nms.holograms.TouchCallback;

import static org.screamingsandals.lib.gamecore.language.GameLanguage.mpr;

public class SpawnerHologramCallback implements TouchCallback {

    @Override
    public void call(Player player, Hologram hologram) {
