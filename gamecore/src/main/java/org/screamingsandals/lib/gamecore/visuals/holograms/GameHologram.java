...
public class GameHologram extends Hologram {
    ...
    public GameHologram(GameFrame gameFrame, HologramType hologramType, List<Player> players,
                        Location loc, List<String> lines) {
        this(gameFrame, hologramType, players, loc, lines, false);
    }

    public GameHologram(GameFrame gameFrame, HologramType hologramType, List<Player> players,
                        Location location, List<String> lines, boolean touchable) {
        super(players, location, lines, touchable);
